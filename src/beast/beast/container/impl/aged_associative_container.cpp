...
class aged_associative_container_Tests : public UnitTest
{
public:
    template <class T>
    struct CompT
    ...
    testCopyMove ()
    {
...

        {
            ...
            expect (std::equal (
                c.cbegin(), c.cend(), c2.cbegin(), c2.cend(),
                    equal_value <Traits> ()));
            checkContents (c2, v);
        }
    ...
    aged_associative_container_Tests () : UnitTest (
